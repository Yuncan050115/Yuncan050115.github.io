...
categories:
  - 计算机基础
abbrlink: s4
cover: https://papi.yuncan.xyz/cover/s_cover.jpg
date: 2023-07-06 10:17:45
updated: 2023-07-06 10:17:45
---

![原图遗失，AI生成](content/assets/ai-2023-07-06-图结构-数据结构与算法-四--4.jpg)

# 图结构篇

图结构在我们的生活中实际上是非常常见的，其中最显著的就是我们的地图了，比如重庆的地图：

![image-20220821222600741](https://oss.itbaima.cn/internal/markdown/2022/09/04/HFR6kX18NnjGx94.png)
...
![image-20220821223128857](https://oss.itbaima.cn/internal/markdown/2022/08/21/zGfXODMAVc7aH34.png)
...
![image-20220822101619660](https://oss.itbaima.cn/internal/markdown/2022/08/22/nqjEmh5YyJlkFZQ.png)
...
![image-20220822104015728](https://oss.itbaima.cn/internal/markdown/2022/08/22/V9BuJt72QH5SEb3.png)
...
![image-20220822112214106](https://oss.itbaima.cn/internal/markdown/2022/08/22/JSr2lIKfZ7X9OeR.png)

如果在一个无向图中，任意两个顶点都有一条边相连，则称该图为**无向完全图**：

![image-20220822121243988](https://oss.itbaima.cn/internal/markdown/2022/08/22/G6tJfjZpaNsx5gE.png)

同样的，在一个有向图中，如果任意两顶点之间都有由方向互为相反的两条边连接，则称该图为**有向完全图**：

![image-20220822113126420](https://oss.itbaima.cn/internal/markdown/2022/08/22/obs24zGhCKmS6Fu.png)

图通过边将顶点相连，这样我们就可以从一个顶点经过某条路径到达其他顶点了，比如我们现在想要从下面的V5点到达V1点：

![image-20220822205354964](https://oss.itbaima.cn/internal/markdown/2022/08/22/1hTPvxCscLg2SKy.png)

那么我们可以有很多种路线，比如经过V2到达，经过V3到达等：

![image-20220822205824613](https://oss.itbaima.cn/internal/markdown/2022/08/22/dsMRoAJiBxVCTju.png)
...
![image-20220822212041079](https://oss.itbaima.cn/internal/markdown/2022/08/22/5hLlIVNf1o4BRuM.png)
...
![image-20220822214010526](https://oss.itbaima.cn/internal/markdown/2022/08/22/jlUfrcTXNPYGvOR.png)
...
![image-20220822220549501](https://oss.itbaima.cn/internal/markdown/2022/08/22/PjTo236CahYf1DZ.png)
...
![image-20220822221214967](https://oss.itbaima.cn/internal/markdown/2022/08/22/AzuomNgXr78TFDp.png)
...
![image-20220830123847943](https://oss.itbaima.cn/internal/markdown/2022/08/30/1XnqfOBEHd4DPTk.png)
...
![image-20220830125309778](https://oss.itbaima.cn/internal/markdown/2022/08/30/2H68yAbFS9GnKD4.png)

对于图中的每个顶点，建立一个数组，存放一个头结点，我们将与其邻接的顶点，通过一个链表进行记录（看着挺像前面讲的哈希表）这样，也可以表示一个图的连接关系，并且内存空间能够得到更加有效的利用。当然，对于无向图来说，跟之前一样，两边都需要进行保存：

![image-20220830141940278](https://oss.itbaima.cn/internal/markdown/2022/08/30/vJ65hqwpuzRLs1O.png)
...
![image-20220830132526621](https://oss.itbaima.cn/internal/markdown/2022/08/30/Colcf6k7hpIGTDt.png)
...
![image-20220830133244446](https://oss.itbaima.cn/internal/markdown/2022/08/30/YlAgIUmGdP2Ej3X.png)
...
![image-20220831141620073](https://oss.itbaima.cn/internal/markdown/2022/08/31/NR1W9HQVnI5rZj8.png)
...
![image-20220831142540478](https://oss.itbaima.cn/internal/markdown/2022/08/31/t7RFJSnBdu2pxcL.png)
...
![image-20220831144250794](https://oss.itbaima.cn/internal/markdown/2022/08/31/WYxKZwDMtej1JXv.png)

### 深度优先搜索（DFS）

我们之前在学习二叉树的过程中，讲解了树的前序遍历，各位回想一下，我们当时是如何在进行遍历的？

![image-20220814145531577](https://oss.itbaima.cn/internal/markdown/2022/08/14/ZRjFywa6kWHrbJY.png)
...
![image-20220831145024885](https://oss.itbaima.cn/internal/markdown/2022/08/31/XgN2k3Ce9VnUDaR.png)

那么我们的路线可以是这样的：

![image-20220831145204170](https://oss.itbaima.cn/internal/markdown/2022/08/31/XO93w5N6tEMIhFZ.png)

此时顶点B有三个方向，那么我们可以先随便选一个方向（当然，一般情况下为了规范，推荐按照字母排列顺序来走，这里为了演示，就随便走了）看看：

![image-20220831145313492](https://oss.itbaima.cn/internal/markdown/2022/08/31/gFIJDkKEOe4bzl5.png)

此时来到K，我们发现K已经是一个死胡同，没有其他路了，那么此时我们就需要回到上一个路口，继续去探索其他的路径：

![image-20220831145530501](https://oss.itbaima.cn/internal/markdown/2022/08/31/NSUDtQTRZfoBnuY.png)

此时我们接着往下一个相邻的顶点G走，发现G有其他的分叉，那么我们就继续向前：

![image-20220831145910420](https://oss.itbaima.cn/internal/markdown/2022/08/31/sp39cE8yhT54F1R.png)

此时走到F发现又是死路，那么退回到G，走其他的方向：

![image-20220831150008288](https://oss.itbaima.cn/internal/markdown/2022/08/31/a8I7smtX6PK3NVe.png)

运气太垃了，又到死胡同了，同样的，回到G继续走其他方向：

![image-20220831150236884](https://oss.itbaima.cn/internal/markdown/2022/08/31/o8MSFfkiHe1ptGV.png)

走到C之后，我们有其他的路，我们继续往后走：

![image-20220831150354010](https://oss.itbaima.cn/internal/markdown/2022/08/31/v4rlfJdkaWCIcOi.png)

此时走到顶点H，发现H只有一条路，并且H再向前是已经走过的顶点B，那么此时不能再向前了，所以说直接退回到C，走另一边：

![image-20220831150617828](https://oss.itbaima.cn/internal/markdown/2022/08/31/JCNUjlfpOgbkLIQ.png)

此时来到E，又有两条路，那么继续随便选一条走：

![image-20220831150820472](https://oss.itbaima.cn/internal/markdown/2022/08/31/IK1AZgGjXr3LqJm.png)

此时来到顶点J，发现又是死胡同，退回到E，继续走另一边：

![image-20220831150913443](https://oss.itbaima.cn/internal/markdown/2022/08/31/3PfzdGYI6Dv745x.png)

好了，经过了这么多试错，终于是找到了I顶点，这种方式就是深度优先搜索了。

那么我们就来打个代码玩玩吧，这里我们构建一个简单一点的图：

![image-20220831152924911](https://oss.itbaima.cn/internal/markdown/2022/08/31/m7lHM3zQvoRs8Uw.png)
...
![image-20220831154358394](https://oss.itbaima.cn/internal/markdown/2022/08/31/gS3uycojfd4GBDT.png)
...
![image-20220831163728799](https://oss.itbaima.cn/internal/markdown/2022/08/31/TNwzR2d5ZGt7Sau.png)

路线如下：

![image-20220831163909522](https://oss.itbaima.cn/internal/markdown/2022/08/31/RZE9zF54cQlYAg8.png)
...
![image-20220831164615659](https://oss.itbaima.cn/internal/markdown/2022/08/31/xAHsYRfzStMwvGT.png)

再来找一下顶点D呢：

![image-20220831164641467](https://oss.itbaima.cn/internal/markdown/2022/08/31/Gwf1XhDIPT3mUzv.png)

可以看到到D之后就停止了，因为已经找到了。那么要是去寻找一个没有连接到图中的结点呢？

![image-20220831164739301](https://oss.itbaima.cn/internal/markdown/2022/08/31/luIONkfmKYPCG2V.png)
...
![image-20220831165617419](https://oss.itbaima.cn/internal/markdown/2022/08/31/hwiEoZ9OM2Fqv47.png)

层序遍历实际上是优先将每一层进行遍历，而不是像前序遍历那样勇往直前，而图的搜索其实也可以采用这种方案，我们可以先探索顶点所有的分支，然后再依次去看这些分支的所有分支：

![image-20220831170114857](https://oss.itbaima.cn/internal/markdown/2022/08/31/qm3OUZbv8XzFLiJ.png)

首先咱还是从A来到B，此时B有三条分叉路，我们依次访问这三条路的各个顶点：

![image-20220831172011576](https://oss.itbaima.cn/internal/markdown/2022/08/31/SCeXgptNDbdFkLi.png)

我们先记录一下这三个顶点，同样需要使用队列来完成：H、G、K

注意访问之后不要再继续向下了，接着我们从这三个里面的第一个顶点H开始，按照同样的方法继续：

![image-20220831172153888](https://oss.itbaima.cn/internal/markdown/2022/08/31/t8c2KVLZM6qx4ui.png)

此时因为只有一个分支，所以说找到C，继续记录，将C也添加进去：G、K、C

注意此时需要回去，继续看之前三个顶点的第二个顶点G：

![image-20220831172312762](https://oss.itbaima.cn/internal/markdown/2022/08/31/Y5qFPAbanH4VcuM.png)

此时C已经看过了，接着就找到了F和D，也是记录一下：K、C、F、D

然后，我们继续看之前三个结点的最后一个：

![image-20220831172726616](https://oss.itbaima.cn/internal/markdown/2022/08/31/3yfDGmKzLbBhcsA.png)

此时K已经是死胡同了，那么就结束，然后继续看下一个C：

![image-20220831172941671](https://oss.itbaima.cn/internal/markdown/2022/08/31/4aTCOYzlm3dLGbt.png)

此时继续将E给记录进去：F、D、E，接着看D和F，也没有后续了，那么最后就只有E了：

![image-20220831173224689](https://oss.itbaima.cn/internal/markdown/2022/08/31/lWyvMUbSdsELVNI.png)
...
![image-20220831184445728](https://oss.itbaima.cn/internal/markdown/2022/08/31/5Mxt2czgTkoUQ9p.png)
...
1. 若一个图的边集为：{(A, B),(A, C),(B, D),(C, F),(D, E),(D, F)}，对该图进行深度优先搜索，得到的顶点序列可能是：
   ...
   *这种题直接把图画出来，因为边集是圆括号，说是肯定是一个无向图，图先画出来再说：*
   ...
   ![image-20220902112113153](https://oss.itbaima.cn/internal/markdown/2022/09/02/WZoIyVGu2n3p5hD.png)
...
3. 如下图所示的无向连通图，从顶点A开始对该图进行广度优先遍历，得到的顶点序列可能是：
   ...
   ![image-20220902110829087](https://oss.itbaima.cn/internal/markdown/2022/09/02/bKRp6Qzu5vo3fEw.png)
...
![image-20220903101036333](https://oss.itbaima.cn/internal/markdown/2022/09/03/lHEi8GWsIjCFg3D.png)
...
![image-20220901180909877](https://oss.itbaima.cn/internal/markdown/2022/09/01/zCap6w2A51rEnkK.png)
...
![image-20220903103444346](https://oss.itbaima.cn/internal/markdown/2022/09/03/ldtA9jbE1JXMcWf.png)
...
![image-20220903111255127](https://oss.itbaima.cn/internal/markdown/2022/09/03/RI5Lrpt8WeOkdZX.png)

我们如果按照深度优先遍历的方式，从G开始，那么就会得到下面的顺序：

![image-20220903112122707](https://oss.itbaima.cn/internal/markdown/2022/09/03/CrsQhon4wxOAjRm.png)

按照顺序我们就可以得到一棵生成树：

![image-20220903112332571](https://oss.itbaima.cn/internal/markdown/2022/09/03/k1IctqPrOA6BKgp.png)
...
![image-20220903112733812](https://oss.itbaima.cn/internal/markdown/2022/09/03/UhRBnocjCL3uD9E.png)

最后得到的生成树为：

![image-20220903113108162](https://oss.itbaima.cn/internal/markdown/2022/09/03/FKRSnvProHtXegi.png)
...
![image-20220903113954010](https://oss.itbaima.cn/internal/markdown/2022/09/03/BWEzS1YOwDohRdU.png)

构建最小生成树有两种算法，一种是**普利姆（Prim）**算法，还有一种是**克鲁斯卡尔（Kruskal）**算法，我们先来讨论第一种：

我们以下图为例：

![image-20220903142138573](https://oss.itbaima.cn/internal/markdown/2022/09/03/c4Xge3QImBdDKYt.png)

普利姆算法的核心就是从任意一个顶点开始，不断成长为一棵树，每次都会选择尽可能小的方向去进行延伸，比如我们一开始还是从顶点A开始：

此时与A相连的边有B和E，A的延伸方向有两个，此时我们只需要选择一个最小的就可以了：

![image-20220903142208537](https://oss.itbaima.cn/internal/markdown/2022/09/03/LZ5ho6mxtweRPMg.png)

此时我们已经构建出了由A、E组成的一棵树，同样的，我们需要去寻找与当前树中A、E顶点相连的所有顶点，包括B、G、H，哪一个最小，那么下一个延伸的就是哪一个，此时发现H和E之间最小，继续延伸：

![image-20220903142245688](https://oss.itbaima.cn/internal/markdown/2022/09/03/zT75jqNVS4RX3bI.png)

现在已经变成了由A、E、H组成的一棵树，同样的，按照之前的思路继续寻找一个最小的方向进行延伸：

![image-20220903142413604](https://oss.itbaima.cn/internal/markdown/2022/09/03/nJWbov1LZNBR8lX.png)

继续进行延伸，发现F、K之间最小：

![image-20220903142558882](https://oss.itbaima.cn/internal/markdown/2022/09/03/OyGRMXi9K5fE3zD.png)

此时K、B和K、D和K、H的权重都是4，其中H顶点已经走过了，不能出现回路，所以说不考虑，此时随便选择K、B或是K、D都可以，不会影响后续结果：

![image-20220903142829606](https://oss.itbaima.cn/internal/markdown/2022/09/03/uxI21o4vnbdNLkB.png)

此时依然是K、D为最小，所以说直接选择：

![image-20220903142917096](https://oss.itbaima.cn/internal/markdown/2022/09/03/cR2BPhbI5X9jAU3.png)

紧接着，我们发现最小权重的来到了5，此时权重为5的边有B、E和H、I和B、D，但是由于E、D已经走过，此时直接选择H、I即可：

![image-20220903143057702](https://oss.itbaima.cn/internal/markdown/2022/09/03/Lg5Tf1Y2AQ9hjNk.png)

接着，我们发现I、G也是5，直接选择即可：

![image-20220903143509563](https://oss.itbaima.cn/internal/markdown/2022/09/03/sgfxIojGRUYdQHc.png)

然后最小权重此时就是6了，选择H、J和I、J都可以，随便选择一个即可：

![image-20220903143532060](https://oss.itbaima.cn/internal/markdown/2022/09/03/T6BoY4IXa3fKpir.png)

此时，整个图的所有顶点就遍历完成了，现在我们去掉那些没用被采用的边，得到的结果就是我们的最小生成树了：

![image-20220903143645249](https://oss.itbaima.cn/internal/markdown/2022/09/03/eVyJ6o8xraRvl3d.png)
...
![image-20220903144403449](https://oss.itbaima.cn/internal/markdown/2022/09/03/qdNyC6We2cZHTog.png)

首先我们直接找到最小边，K、F，它的权值为2，所以说直接选择就行：

![image-20220903144533239](https://oss.itbaima.cn/internal/markdown/2022/09/03/tTq2NnfJPcvogFG.png)

紧接着就是F、H的边，权重为3，目前最小的了：

![image-20220903144828106](https://oss.itbaima.cn/internal/markdown/2022/09/03/MtJxvkjZoScT2KH.png)

此时最小的权重就只有4了，目前有4条边都可以进行选择，但是K、H这条边因为K和H都已经在树中了，所以说不能考虑，其他三条边都是没问题的，我们随便选择一条就行了：

![image-20220903145239074](https://oss.itbaima.cn/internal/markdown/2022/09/03/9vEVncqotmeklr7.png)

继续选择权重为4的边：

![image-20220903145321395](https://oss.itbaima.cn/internal/markdown/2022/09/03/BXZjrOTYfow51iD.png)

此时权重就来到了5，那么权重为5的顶点我们也可以随便选择一条，只要不会导致出现回路就行了：

![image-20220903145431925](https://oss.itbaima.cn/internal/markdown/2022/09/03/qUd8hiGnYyAZLo5.png)

此时连接G、I，我们发现出现了两棵树，没关系的，最后会连成一棵树的，我们继续选择其他权重为5的边：

![image-20220903145551091](https://oss.itbaima.cn/internal/markdown/2022/09/03/hpcVj8HwRJnvaf9.png)

此时我们选择A、E这条边，然后是H、I这条边，虽然这条边上的H和I顶点都已经在树中了，但是它们并不属于同一棵树，这种情况也是可以连接的，然后我们继续选择权重为6的顶点：

![image-20220903145828812](https://oss.itbaima.cn/internal/markdown/2022/09/03/Sltei9m4GdHXQkW.png)
...
![image-20220903150609366](https://oss.itbaima.cn/internal/markdown/2022/09/03/FuxnpoTNezYP9Aa.png)
...
![image-20220903153802247](https://oss.itbaima.cn/internal/markdown/2022/09/03/6ABvydlgPUqEYIZ.png)

要解决这种问题，我们可以采用**迪杰斯特拉（Dijkstra）**算法，下面我们来看看迪杰斯特拉算法是如何让计算机来计算最短路径的，它跟普利姆算法求最小生成树有着很多相似之处，我们就从A出发，这里我们需要一个表来记录：

![image-20220903195351496](https://oss.itbaima.cn/internal/markdown/2022/09/03/cU2s1vRGq9SJkpE.png)

dist这一行记录A到其他顶点的最短路径，path这一行记录的是最短路径所邻接的顶点，我们首先还是从A开始，与A直接相邻的两个分别是B和D，其中B的距离是2，D的距离是5，那么我们就先进行一下记录：

![image-20220903195723929](https://oss.itbaima.cn/internal/markdown/2022/09/03/fxAocwRZFzSYgBb.png)

因为都是从A过来的，所以说直接记录为A即可，接着我们继续找到当前A路径最短的一个顶点B，此时顶点B可以到达C、D、A，因为不能走回头路，不考虑A，那么目前从A到达C的最短距离就是经过B到达的，相当于A->B加上B->C的距离：

![image-20220903230103368](https://oss.itbaima.cn/internal/markdown/2022/09/03/nbhD6gKrcWHZYwF.png)

然后我们来看顶点D，此时我们发现，除了A直接到D之外，从B也可以到达D，那么我们就可以比较一下，看是从B到D更短一些，还是从A直接到D更短一些 $min(2 + 2, 5)$ ，通过比较，我们发现从B绕过去会更短一些，只需要4即可，所以说我们将其更新一下：

![image-20220903230254335](https://oss.itbaima.cn/internal/markdown/2022/09/03/wZtX2eCvWciJ7mo.png)

接着我们继续找到下一个离A最近的顶点D，D与顶点E和J相连，直接更新即可，比如E的最短路径就是相当于是A到D的最短路径加上D到E的路径，D到J也是同理：

![image-20220903230521739](https://oss.itbaima.cn/internal/markdown/2022/09/03/RndcpoWkY6Oe84y.png)

此时继续找到表中下一个距离A最近的顶点J，J可以到达H或者是E，按照同样的方式，我们看看是从D直接到E更短，还是从J到E更短，进行比较 $min(6 + 3, 8)$ ，得到结果是D直接过去更短，所以说不需要更新。然后H更新为J过去的最短路径：

![image-20220903231152767](https://oss.itbaima.cn/internal/markdown/2022/09/03/d8qoaxZiymTGBlv.png)

我们接着来看下一个距离A最近的顶点C，此时C可以到达F和E，我们先来看E，还是对其进行比较，如果从C到达E更短，那么就更新为新的值，$min(7 + 4, 8)$，最后仍然是从D到E最短，所以说不变，接着我们把F的值更新一下：

![image-20220903231449081](https://oss.itbaima.cn/internal/markdown/2022/09/03/uknUSC2gK5adZjL.png)
...
![image-20220903232316607](https://oss.itbaima.cn/internal/markdown/2022/09/03/Ek7nhJuXtKSZgeo.png)

我们继续来到下一个离A最近的顶点F，F连接了G和E，但是由于当前最短路径是从E过来的，不能走回头路，所以说直接去看G，比较 $min(10 + 5, 17)$，得到从F到达G会更短，所以说更新G：

![image-20220903232542904](https://oss.itbaima.cn/internal/markdown/2022/09/03/mphBFRsLArDQHwK.png)

然后我们接着看到下一个最短的顶点H，此时H与G和I相连，我们先来看G，$min(13 + 3, 15)$，维持原方案。然后是I，直接更新即可：

![image-20220903232752582](https://oss.itbaima.cn/internal/markdown/2022/09/03/PlHs4NE8JTiFZad.png)
...
![image-20220903233144469](https://oss.itbaima.cn/internal/markdown/2022/09/03/RL9XeTnAJBdUNMF.png)
...
![image-20220904094948962](https://oss.itbaima.cn/internal/markdown/2022/09/04/MdPc7Ew96Ukzxjt.png)

我们可以很轻松地得到它的邻接矩阵：

![image-20220904101234641](https://oss.itbaima.cn/internal/markdown/2022/09/04/ZQ7KvWeuJ6bdThx.png)
...
![image-20220904102258851](https://oss.itbaima.cn/internal/markdown/2022/09/04/czu5FEq8gGsRC97.png)

此时我们看到，除了对角线以外，就是B->C和C->B的这两个位置，我们按照上面的规则，进行计算：

![image-20220904102738649](https://oss.itbaima.cn/internal/markdown/2022/09/04/i3csRCQaxW17jV9.png)

同样的，我们继续看到C->B这个为止，按照同样的方式进行更新：

![image-20220904103010762](https://oss.itbaima.cn/internal/markdown/2022/09/04/TsIgShcqrdR3BaQ.png)

最后更新完成得到的结果如下：

![image-20220904103033008](https://oss.itbaima.cn/internal/markdown/2022/09/04/dObC8f2u6SqX4eT.png)

实际上我们发现，我们计算的和相当于是绕路的结果与当前直接走的结果相比较得到的。按照的同样的方式，我们开始第二轮：

![image-20220904103410691](https://oss.itbaima.cn/internal/markdown/2022/09/04/tXkEVLqR5dIchWT.png)

更新完成之后，C->A的距离变成了5：

![image-20220904103549079](https://oss.itbaima.cn/internal/markdown/2022/09/04/b9SGVFR6xEWBtgp.png)

我们接着来看最后一轮：

![image-20220904103724239](https://oss.itbaima.cn/internal/markdown/2022/09/04/alRYcGDp8xETLn1.png)

此时我们将A->B的距离也更新一下：

![image-20220904103815369](https://oss.itbaima.cn/internal/markdown/2022/09/04/Qwa2JMLXYBhnFsd.png)
...
![image-20220904105442929](https://oss.itbaima.cn/internal/markdown/2022/09/04/9fuBUwRYav4bghd.png)
...
![image-20220904110149836](https://oss.itbaima.cn/internal/markdown/2022/09/04/mDWY8ZzqSipRGFa.png)
...
![image-20220904110937920](https://oss.itbaima.cn/internal/markdown/2022/09/04/OoPBQgd9WrSJhNx.png)
...
![image-20220904121459739](https://oss.itbaima.cn/internal/markdown/2022/09/04/uMWBeLlzh9vHpdC.png)

那么我们在程序中如何对一个有向无环图进行拓扑排序呢？以上图为例，其实很简单，我们还是利用队列来完成，我们每次只需要将那些入度为0的顶点，丢进队列中（注意丢进去之后记得更新一下图中其他顶点的入度）首先从A：

![image-20220904122602140](https://oss.itbaima.cn/internal/markdown/2022/09/04/7bRdsEGLMqokZCf.png)

此时队列中有A这个顶点，接着我们来看看图中剩余的顶点，哪些又是入度为0的顶点，可以看到D也是：

![image-20220904122621668](https://oss.itbaima.cn/internal/markdown/2022/09/04/quj1yedrT69OQz3.png)
...
![image-20220904122914376](https://oss.itbaima.cn/internal/markdown/2022/09/04/23gdNArusypQS84.png)

接着，我们继续让D出队，我们发现D出队之后，E变成了入度为0的顶点，所以说将E入队：

![image-20220904123206951](https://oss.itbaima.cn/internal/markdown/2022/09/04/wjZ4TFslOL69IBA.png)

接着我们继续出队，B出队之后，我们发现没有任何顶点入度变为0了，所以说不管，继续：

![image-20220904123257858](https://oss.itbaima.cn/internal/markdown/2022/09/04/gWDMYimuxjFN45O.png)

继续将E出队，在E出队之后，顶点F、C都变成了入度为0的顶点，统统入队：

![image-20220904123445483](https://oss.itbaima.cn/internal/markdown/2022/09/04/uiXtEYK5aIWxNl4.png)

此时继续将C出队，我们发现没有任何顶点入队变为0，我们继续来看F：

![image-20220904123544940](https://oss.itbaima.cn/internal/markdown/2022/09/04/ue1dkjGcLKg3TCY.png)

当F出队后，顶点G变成了入度为0的顶点，此时将G入队：

![image-20220904123635522](https://oss.itbaima.cn/internal/markdown/2022/09/04/yqDC2BFQpElfz1L.png)

剩下就是把G出队，然后F入队F再出队了：

![image-20220904123742305](https://oss.itbaima.cn/internal/markdown/2022/09/04/2Na4UxFBJV6u3eR.png)
...
![image-20220904130014247](https://oss.itbaima.cn/internal/markdown/2022/09/04/uUPRtKrGBbXlNHi.png)
...
![image-20220904132328013](https://oss.itbaima.cn/internal/markdown/2022/09/04/E8UqCQoylmLMuZA.png)

我们需要计算两个东西，一个是**事件最早完成时间**（也就是要完成这个事件最快要多久），还有一个是**事件最晚开始时间**（就是这个事件在不影响工期的情况下最晚可以多久开始）：

![image-20220904132930050](https://oss.itbaima.cn/internal/markdown/2022/09/04/GeXishvJ5wmKUHW.png)

我们依然是按照之前的拓扑排序的顺序进行，首先一开始是A，因为只有一个起点A肯定是可以直接开始的，所以说最早和最晚时间都是0（注意如果出现多个起点的话，最晚开始时间就不一定了），我们接着AOE图的工作顺序，来计算任务B和C的最早和最晚时间：

![image-20220904133246766](https://oss.itbaima.cn/internal/markdown/2022/09/04/YFJonUm1x6H5AOl.png)

接着就是D和E，首先D需要B和C同时完工之后才能继续，那么也就是说需要选择B和C过来时间最长的那一个：

![image-20220904133658962](https://oss.itbaima.cn/internal/markdown/2022/09/04/qo1ZwWgSji45uv3.png)

最后就是F，到达F一共有三条路径，我们依然是选择最长的那一条，从D过来总共需要8天时间：

![image-20220904133802361](https://oss.itbaima.cn/internal/markdown/2022/09/04/M4UzkX9ePgtSV2c.png)

故整个工程的最早完成时间为8天，我们接着来看活动的最晚开始时间，现在我们要从终点倒着往回看：

![image-20220904134114068](https://oss.itbaima.cn/internal/markdown/2022/09/04/EsHI4DSYjWAVfvB.png)

首先终点一定是8，因为工期最快是在8天结束的，我们继续倒着往回走，先来看E，E需要6天才能到达，但是只需要1天就可以结束，所以 8 - 1 = 7，最晚可以在第7天时动工：

![image-20220904134310369](https://oss.itbaima.cn/internal/markdown/2022/09/04/8W2mo5D1vFN9ur6.png)

然后是D，因为D到F需要2天时间，而D已经是第6天了，总时间8天，所以说D刻不容缓，第6天就需要马上开工：

![image-20220904134445037](https://oss.itbaima.cn/internal/markdown/2022/09/04/mTkRZXpP8necDyf.png)
...
![image-20220904135059487](https://oss.itbaima.cn/internal/markdown/2022/09/04/7YbvfGVhlwO1yJR.png)
...
![image-20220904135338214](https://oss.itbaima.cn/internal/markdown/2022/09/04/oyInZ68SxJqYm5R.png)
